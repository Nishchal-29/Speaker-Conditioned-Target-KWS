"""
Generates the 200-word validation benchmark list for TC-ResNet training.

This list is heavily weighted with hard negatives to test the resolving
power of the metric encoder:
  - Minimal pairs (accept/except, affect/effect)
  - Rhymes (activate/captivate, tornado/tomato)
  - Compound confusions (snow/snowball, base/baseball)

Run once:
    python generate_val_list.py

Output:
    ../data/val_words.txt  (200 words, one per line, lowercase)
"""
